...
@NamedQueries({
    ...
    @NamedQuery(name = "Album.findByNomeArtistaAlbum", query = "SELECT a FROM Album a WHERE a.nomeArtistaAlbum = :nomeArtistaAlbum"),
    @NamedQuery(name = "Album.findByGeneroAlbum", query = "SELECT a FROM Album a WHERE a.generoAlbum = :generoAlbum"),
    @NamedQuery(name = "Album.findByDataLancamentoAlbum", query = "SELECT a FROM Album a WHERE a.dataLancamentoAlbum = :dataLancamentoAlbum")})
public class Album implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "data_lancamento_album")
    ...
    public Album(Integer idAlbum, String tituloAlbum, String nomeArtistaAlbum, String generoAlbum, String dataLancamentoAlbum) {
        this.idAlbum = idAlbum;
    ...
    public void setDataLancamentoAlbum(String dataLancamentoAlbum) {
        this.dataLancamentoAlbum = dataLancamentoAlbum;
    }
